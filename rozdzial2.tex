...
Ponieważ każda runda składa się z ciągu wykonywanych przez graczy tur, których stan zależy od podjętej wcześniej decyzji, to model matematyczny problemu optymalizacyjnego można przedstawić za pomocą programowania dynamicznego:
...
\begin{itemize}
	...
	\item $F_{(S_(n-1)}$ - funkcja zwracająca $x_n$
\end{itemize}
...
\end{itemize}
By rozwiązać przedstawiony problem optymalizacyjny należy zdefiniować $F_{(S_(n-1)}$, czym zajmuję się w następnym rozdziale.